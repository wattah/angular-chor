...
@Component({
  selector: 'app-hardware-park-item',
  templateUrl: './hardware-park-item.component.html',
  styleUrls: ['./hardware-park-item.component.scss']
})
export class HardwareParkItemComponent implements OnInit {
