...
import { InterventionReportVO } from './cri/intervention-report-vo';
...
export interface GenericDataObject {
  ...
  active:boolean;
  date:Date;
  parent:GenericDataObject;
  childs:GenericDataObject[];
}

export interface InteractionReasonVO extends GenericDataObject {
  id: number;
  label: string;
  ordinal: number;
  active: boolean;
...
export interface RequestCreationContextVO {
  ...
  businessAccountManagerId: number;
  origin: ReferenceDataVO;
  originId: number;
}
