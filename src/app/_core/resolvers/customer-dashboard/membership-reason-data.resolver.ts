...
@Injectable({
 ...
 export class MembershipReasonDataResolver implements Resolve<Observable<ReferenceDataVO[]>> {
  ...
  resolve(route: ActivatedRouteSnapshot): Observable<ReferenceDataVO[]> {
    return this.referencesDataService.getReferencesData('MEMBERSHIP_REASON');
  }
